...
public class ComputadorSetCollection extends org.orm.util.ORMSet {
	...
	*/
	 ...
	 */
	public void add(Computador value) {
		if (value != null) {
	 ...
	 * @param value the persistent object
	 */
	public void remove(Computador value) {
	 ...
	 */
	public boolean contains(Computador value) {
	 ...
	 */
	public Computador[] toArray() {
		return (Computador[]) super.toArray(new Computador[size()]);
	}
	 ...
	 */
	public Computador[] toArray(String propertyName) {
	 ...
	 * @return The persistent objects sorted array
	 */
	public Computador[] toArray(String propertyName, boolean ascending) {
