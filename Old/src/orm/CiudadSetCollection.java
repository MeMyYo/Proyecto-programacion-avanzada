...
public class CiudadSetCollection extends org.orm.util.ORMSet {
	...
	*/
	 ...
	 * @param value the persistent object
	 */
	public void remove(Ciudad value) {
	 ...
	 */
	public boolean contains(Ciudad value) {
	 ...
	 */
	public Ciudad[] toArray() {
		return (Ciudad[]) super.toArray(new Ciudad[size()]);
	}
	 ...
	 */
	public Ciudad[] toArray(String propertyName) {
	 ...
	 * @return The persistent objects sorted array
	 */
	public Ciudad[] toArray(String propertyName, boolean ascending) {
