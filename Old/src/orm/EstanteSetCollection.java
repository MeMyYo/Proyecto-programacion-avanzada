...
public class EstanteSetCollection extends org.orm.util.ORMSet {
	...
	*/
	 ...
	 * @param value the persistent object
	 */
	public void remove(Estante value) {
	 ...
	 */
	public boolean contains(Estante value) {
	 ...
	 */
	public Estante[] toArray() {
		return (Estante[]) super.toArray(new Estante[size()]);
	}
	 ...
	 * <li>idEstante</li>
	 * <li>capacidadAproximada</li>
	 * </ul>
	 * @return The persistent objects sorted array
	 */
	public Estante[] toArray(String propertyName) {
	 ...
	 * @return The persistent objects sorted array
	 */
	public Estante[] toArray(String propertyName, boolean ascending) {
